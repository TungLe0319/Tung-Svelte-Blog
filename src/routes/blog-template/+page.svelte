<script>
  ...
  import blog from '$lib/blog_template.json';
  const comments = [
    {
      id: "comment1",
      commenter: {
...
<Section name='blogTemplate' classSection=' pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900'>
  <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert prose ">
    <BlogTemplate {blog} />
