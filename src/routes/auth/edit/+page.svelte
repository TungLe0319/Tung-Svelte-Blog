...
import {goto} from '$app/navigation'
  ...
  export let data;
  let id = $AppState.activePost ? $AppState.activePost.id : "";
  let title = $AppState.activePost ? $AppState.activePost.title : "";
  let img = $AppState.activePost ? $AppState.activePost.img : "";
  let subtitle = $AppState.activePost ? $AppState.activePost.subtitle : "";
  let content = $AppState.activePost ? $AppState.activePost.content : "";
  let published = $AppState.activePost ? $AppState.activePost.published : false;
  let selected = $AppState.activePost
    ? $AppState.activePost.categories.map((c) => c.name)
    : [];
